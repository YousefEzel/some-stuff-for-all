...
function installtorbrowser {
	...
	if [[ $install = Y || $install = y ]] ; then
			...
			if [ "$operatingsys" == "32" ]; then 
				...
				wget https://www.torproject.org/dist/torbrowser/6.0.8/tor-browser-linux32-6.0.8_en-US.tar.xz
				echo -e "\e[31m[-] Done with download!\e[0m"
				echo -e "\e[1;33m[+] Installing Tor Browser\e[0m"
				tar -xf tor-browser-linux32-6.0.5_en-US.tar.xz
				cd /root/Bureau/tor-browser_en-US/Browser/
				...
				cd /root/Téléchargements/
				wget https://www.torproject.org/dist/torbrowser/6.0.8/tor-browser-linux64-6.0.8_en-US.tar.xz
				echo -e "\e[31m[-] Done with download!\e[0m"
				echo -e "\e[1;33m[+] Installing Tor Browser\e[0m"
